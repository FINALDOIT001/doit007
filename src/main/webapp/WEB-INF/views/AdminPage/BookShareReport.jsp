			...
			<tr style="text-align:center;">
				...
				<td>
          			...
          			<c:url var="bsView" value="bsView.ev">
						<c:param name="bsNo" value="${ rpList.rpBno }"/>
					</c:url>
				
					<a href="${ bsView }" onclick="window.open(this.href, '_blanck', 'width=1300, height=1300, scrollbars=no'); return false">
